        ...
        if(federated){
            ...
            for (String nimbleURL : nimbleURLs) {
                ...
                try {
                    ...
                    if(filters.getStartDate() != null && filtersFromFederation.getStartDate() != null){
                    ...
                    if(filters.getEndDate() != null && filtersFromFederation.getEndDate() != null){
